...
const VolumeControl = ({onClick, isMuted, volume,onVolumeChange}) =>
  <div className={"player__volume"}>
    <svg width="36px" height="36px" viewBox="0 0 36 36" className={"media-control media-control--mute-unmute"} onClick={onClick}>
    ...
    <input type="range" disabled={isMuted} min={0} max={1} step="any" value={volume} onChange={onVolumeChange} />
  </div>;
